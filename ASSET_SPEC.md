...
- 旋转类战斗单位的基础朝向统一为：`朝右`
  - 包括：玩家、普通敌人、Boss、篮球投射物、漏出鸡脚追击单位
...
|---|---|---:|---:|---:|---|---|
| `weapon_basketball_icon` | 篮球图标 | `128x128` | `64x64` | `48x48` | 中心 | 朝右 |
| `weapon_jntm_icon` | 鸡你太美图标 | `128x128` | `64x64` | `48x48` | 中心 | 朝右 |
| `weapon_chicken_foot_icon` | 漏出鸡脚图标 | `128x128` | `64x64` | `48x48` | 中心 | 朝右 |

#### 投射物

| ID | 用途 | 源画布 | 接入 PNG | 游戏显示 | Pivot | 朝向 |
|---|---|---:|---:|---:|---|---|
| `proj_basketball` | 篮球投射物 | `64x64` | `32x32` | `12x12` | 中心 | 朝右 |
| `proj_bullet_player` | 玩家普通子弹 | `32x32` | `16x16` | `12x12` | 中心 | 朝右 |
| `proj_bullet_enemy` | 敌方子弹 | `32x32` | `16x16` | `12x12` | 中心 | 朝右 |
| `proj_rooster` | 漏出鸡脚追击单位 | `128x128` | `64x64/帧` | `20x20` | 中心 | 朝右 |
| `fx_jntm_room_blast` | 鸡你太美全房间攻击闪光 | `1920x1280` | `960x640/帧` | `960x640` | 屏幕中心 | 无 |

说明：

- 子弹不建议做太复杂，优先保证高速移动下的辨识度。
- 篮球投射物高速连射时必须仍能辨识为球形，不要依赖复杂小字。
- 漏出鸡脚追击单位必须基础朝右，代码会按速度方向旋转。

### M2 增强

| ID | 用途 | 源画布 | 接入 PNG | 游戏显示 | 动画要求 |
|---|---|---:|---:|---:|---|
| `fx_basketball_muzzle` | 篮球发射闪光 | `128x128` | `64x64/帧` | `20x20` | `strip4` |
| `fx_berserk_aura` | 狂暴模式角色光环 | `128x128` | `64x64/帧` | `40x40` | `strip6` |
